...
if __name__=="__main__":
    ...
    default_image_name = user_name + '-tabletopgym'
    ...
    parser.add_argument("-c", "--container", type=str, default="tabletopgym", help="(optional) name of the container")
    ...
    # bindings
    cmd += " -v %(source_dir)s:%(home_directory)s/tabletopGym" \
